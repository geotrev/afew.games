...
To start, let's do a quick recap. What is a key factor for collectors buying video games? Often, it's the print run. Earlier prints tend to be most sought after for a few reasons, but most importantly: they're always less available than those from subsequent print runs.
